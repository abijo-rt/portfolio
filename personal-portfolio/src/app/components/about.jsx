...
const About = () => {
  return (
    <div className='bg-[#a67cfe] relative' id='about' >
         <div className=' flex h-fit sm:h-screen w-screen items-center justify-center   sm:px-32 sm:flex-row flex-col'>
         <div className='flex flex-col h-[10%] sm:h-3/4 w-1/4 items-start justify-start '>
         <div className='text-[#513671] font-mono text-6xl '>About</div><br/>
         <div className='font-mono text-4xl sm:block hidden '>&quot;The only way to do great work is to love what you do..&quot;</div>
         </div>

         <div className='flex  h-3/4 w-3/4 items-center justify-center sm:pl-32'>

<div className='border-[#764fa4] border-2 h-fit w-full bg-[#d9ffb5] p-10 text-black font-medium font-mono rounded-lg shadow-md shadow-[#d9ffb5]'>
...
<br/>
<br/>
<p className=' flex items-center '><img src='./assets/col.svg ' className='size-8 sm:ml-10 hover:animate-pulse'></img><p className='ml-10'>Bannari Amman Institute Of technology</p></p>
<br/>
<p className=' flex items-center '><img src='./assets/loc.svg ' className='size-8 sm:ml-10 hover:animate-pulse'></img><p className='ml-10'>Kanyakumari, Tamil Nadu, India</p></p>
<br/>
<p className=' flex items-center '><img src='./assets/ed.svg ' className='size-8 sm:ml-10 hover:animate-pulse'></img><p className='ml-10'>HSC | SSLC | B.Tech Information technology</p></p>
<br/>
<p className=' flex items-center '><img src='./assets/mail.svg ' className='size-8 sm:ml-10 hover:animate-pulse'></img><p className='ml-10'>abijorajesh@gmail.com</p></p>
